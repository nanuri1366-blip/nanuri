...
export const INITIAL_RAW_MATERIALS = [
  { id: 'mat_oranda_grain', name: '오란다 알갱이', stock: 50.0, unit: 'kg', unit_price: 12000, sort_order: 1 },
  { id: 'mat_kkaburi_grain', name: '까부리 알갱이', stock: 40.0, unit: 'kg', unit_price: 13500, sort_order: 2 },
  { id: 'mat_rice_syrup', name: '쌀조청', stock: 60.0, unit: 'kg', unit_price: 8500, sort_order: 3 },
  { id: 'mat_yuzu_syrup', name: '고흥 생유자청', stock: 45.0, unit: 'kg', unit_price: 18000, sort_order: 4 },
  { id: 'mat_pumpkin_seeds', name: '호박씨', stock: 25.0, unit: 'kg', unit_price: 16000, sort_order: 5 },
  { id: 'mat_peanuts', name: '볶음 땅콩', stock: 30.0, unit: 'kg', unit_price: 11000, sort_order: 6 },
  { id: 'mat_almonds', name: '아몬드 슬라이스', stock: 20.0, unit: 'kg', unit_price: 22000, sort_order: 7 },
  { id: 'mat_sunflower_seeds', name: '해바라기씨', stock: 25.0, unit: 'kg', unit_price: 14000, sort_order: 8 },
  { id: 'mat_vinyl_wrap', name: '개별 포장 비닐', stock: 3000, unit: '개', unit_price: 35, sort_order: 9 },
  { id: 'mat_gift_box', name: '선물 패키지 박스', stock: 450, unit: '개', unit_price: 1200, sort_order: 10 },
  { id: 'mat_shipping_box', name: '택배 포장 박스', stock: 300, unit: '개', unit_price: 850, sort_order: 11 }
];
